...
class SumoRampEnv:
    def __init__(self):
        # Use sumo-gui to start SUMO with the graphical interface
        self.sumoCmd = [
            "sumo-gui",  # Start with GUI instead of headless sumo
...
def main():
    global EPSILON  # Declare EPSILON as global at the start of the function
    env = SumoRampEnv()
